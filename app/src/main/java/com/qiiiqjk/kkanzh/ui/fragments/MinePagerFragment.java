...
import com.qiiiqjk.kkanzh.ui.activitys.UserActivity;
...
import com.qiiiqjk.kkanzh.views.mine.SelectItemView;
...
public class MinePagerFragment extends XBaseFragment implements View.OnClickListener{
    ...
    private void login(){
        ...
        login.addOnLoginListener(new LoginDialogFragment.onLoginListener() {
            @Override
