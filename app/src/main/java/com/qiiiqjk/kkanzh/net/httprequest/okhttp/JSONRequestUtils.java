package com.qiiiqjk.kkanzh.net.httprequest.okhttp;
...
public class JSONRequestUtils {
    private static final String TAG = JSONRequestUtils.class.getSimpleName();
    /**
     * json格式请求数据
     * @author leibing
     * @createTime 2017/5/6
     ...
     * @return
     */
    public static Request jsonRequet(String url, HashMap<String,String> params){
     ...
     * @return
     */
    private static RequestBody jsonBody(HashMap<String, String> params) {
        String json = "";
